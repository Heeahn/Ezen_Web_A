...
<title>Main</title>
	...
	<style type="text/css">
		...
		#sidebar .title1{background-color: #0ca9a3;color: white; padding: 15px;font-size: 18px;}
		...
		#right_main .items{float: right; width: 190px;margin-top: 30px; }
		#right_main .subject{margin-top: 10px; font-size: 15px; font-weight: bold;}
