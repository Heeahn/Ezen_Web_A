...
<title>Footer</title>
	<style type="text/css">
		#footer{ clear: both; background-color:#05354e; color: white;  height: 250px;}
		#footer_menu{padding: 20px;	font-weight: bold;}
		#footer_menu li{display: inline;	/*가로배치 */margin-right: 30px;	/* 간격 */}
		#footer .items{float: left;margin: 20px 100px 20px 20px;}
