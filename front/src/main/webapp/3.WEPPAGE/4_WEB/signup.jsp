	...
	<div class="container">
		...
		<div class="col-md-6">
			...
			padding: 5px;">
				...
				<h5 style="color: gray"> 필수 약관을 동의 하셔야 회원가입 가능  </h5>
			</div>
				<div style="font-size: 30px; margin-top: 10px;">
					<span >회원가입 약관동의</span> <span style="color: red">*</span>
				</div>
			<div >
				<textarea rows="8" cols="62"  readonly="readonly" style="resize: none;">제 1장 총칙
제 1 조(목적)
...
부 칙 1. (시행일) 본 약관은 2016년 1월 1일부터 시행됩니다.</textarea>
			...
			<div>
				<textarea rows="8" cols="62"  readonly="readonly" style="resize: none;">가. 개인정보의 수집 및 이용 목적
