/**
 * 
 	js[사용목적 : 유효성 검사, 비동기통신(화면전환없는통신) 등]
 	js문법
 		1. 주석 : java 동일
 		2. 변수선언
 		...
 		4. 반복문/제어문
 			...
 			2. if(논리식){}
 */
//var 메시지1 = "자바 var 변수"; alert(메시지1); console.log(메시지1);
// var 메시지1 = "자바 var 중복변수";  alert(메시지1);
 
//변수 var : 중복 가능, 메모리 초기화 가능

// const 메시지4 = "자바 const변수";  alert(메시지4);
//메시지4 = "자바 const 변수 값 변경"; alert(메시지4);

//변수 const : 변수명 중복 불가능, 메모리 초기화 불가능 = 상수, 고정값
...
let tag1 = document.getElementById("spantag1");
 ...
 function 함수1(){ // html 태그내 이벤트태그에서 함수호출 해야 실행 가능
	let 색상배열 = ['red','white','black'];
	// 배열 선언 : let 배열명 = [값1, 값2, 값3 ~~];
	// 배열 호출 : 
