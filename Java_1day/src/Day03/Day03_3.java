...
//		System.out.println("점수입력: "); int 점수 = scanner.nextInt();
//		
...
//		//				점수가 70점 이상이면 C등급
//		//				그외 재시험
//		System.out.println("점수입력: "); int 점수1 = scanner.nextInt();
//		
...
//		
		...
		if( id.equals("admin")) { // id는 클래스 객체이기 때문에 == 불가능 // 객체비교시에는 .equals
			//입력한 id가 admin 이면
		   if(pw==1234) {
			   //입력한 pw 1234이면
		   ...
		   else {System.out.println("알림) 비밀번호가 틀렸습니다.");}  
