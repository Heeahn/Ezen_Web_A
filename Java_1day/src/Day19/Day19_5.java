...
public class Day19_5 {
	...
	public static void main(String[] args) {
		...
		System.out.println(scores.lower(95)); // 95 기준으로 왼쪽 노드
		System.out.println(scores.higher(95)); // 95 기준으로 오른쪽 노드
		System.out.println(scores.floor(95)); // 95포함 기준으로 왼쪽 노드
		System.out.println(scores.ceiling(85)); // 85포함 기준으로 오른족 노드
		//4. 삭제
		System.out.println(scores.pollFirst()); // 가장 왼쪽 노드 삭제
